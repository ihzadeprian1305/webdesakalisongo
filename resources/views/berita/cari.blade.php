        ...
        <div>
            <div class="da-section" id="structure">
                <div class="container">
                    ...
                    <br>                
                    <div class="alert alert-success" role="alert">Ditemukan {{ $JumlahDataBerita }} Data dengan Kata Kunci : {{ $cari }}</div>
                    @if (!empty($DataBerita))
                    @foreach ($DataBerita as $key => $News )
                    <div class="card mb-3">
                        <div class="row align-items-center">
                            <div class="col-md-4">
                                <img src="{{ asset('public/gambar/'.$News->gambar)}}" class="w-100">
                            </div>    
                            <div class="col-md-8 p-3">
                                <div class="card-block px-3">
                                    ...
                                    <a href="{{url('/berita.'.$News->id_news.'.detail')}}" class="btn btn-primary">Lihat</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    @else
                    <div class="col-sm-12">                  
                        <div class="alert alert-danger" role="alert">Data dengan Kata Kunci : {{ $cari }} Tidak ditemukan, <a href="{{url('/berita')}}"><input type="button" value="Klik Disini Untuk Kembali" class="btn btn-danger"/></a>
                        </div>
                    </div>
                    @endif 
     ...
     <div class="container text-white">
        <div class="row">
            <div class="col-md-5">
                ...
                <p class="mb-3">Kalisongo@gmail.com</p>
