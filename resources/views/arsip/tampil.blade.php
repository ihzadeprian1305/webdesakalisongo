            ...
            <div class="container">
                ...
                <div class="card mb-3">
                    <div class="row align-items-center">
                        <div class="col-md-4">
                            <img src="{{ asset('public/cover/'.$Archive->cover)}}" class="card-equal-height-image w-100">
                        </div>
                        <div class="col-md-8 p-3">
                            <div class="card-block px-3">
                                ...
                                <p class="card-text">{{$Archive->isi}}</p>
                ...
                @endif
                @else
                    <h3 class="h4 mt-3 text-center">Tidak Ada Arsip</h3>
                @endif
            </div>
