            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-tools">
                  <a href="{{ url('/admin/arsip.tambah') }}" 
                  class="btn btn-sm btn-info float-right">
                  <i class="fas fa-plus"></i> Tambah  Arsip Desa</a>
                </div>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
              ...
              <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td align="center">
                         <form action="{{url('/admin/arsip.'.$Archive->id_archive)}}" method="Post" onsubmit="return confirm('Apakah Data Arsip {{$Archive->judul}} Ingin Dihapus?')">
                          @csrf
                   <a href="{{url('/admin/arsip.'.$Archive->id_archive.'.detail')}}" 
                   class="btn btn-xs btn-info" title="Detail">
                    <i class="fas fa-eye"></i></a>
                          
                   <a href="{{url('/admin/arsip.'.$Archive->id_archive.'.edit')}}" 
                   ...
                   <i class="fas fa-edit"></i></a>
                    ...
                    @endforeach
                    @else
                    <tr><td colspan="5">Belum Ada Data Arsip Desa
                    </td></tr>
                    @endif
                    </tbody>
                  </table>  
