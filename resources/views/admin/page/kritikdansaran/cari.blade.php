            ...
            <div class="card">
             ...
             <i class="fas fa-list-ul"></i> Daftar  Kritik dan Saran</h3>
              ...
              <div class="col-md-12">
                ...
                @if($JumlahDataKritikDanSaran>0)
                
                <div class="col-sm-12">                  
                      <div class="alert alert-success" 
                       role="alert">Ditemukan {{ $JumlahDataKritikDanSaran }} data dengan kata kunci : {{ $cari }}
                      </div>
                </div>
                    ...
                    <tr>
                        ...
                        <td align="center">
                         <form action="{{url('/admin/kritikdansaran.'.$CriticAndSuggestion->id_criticandsuggestion)}}" method="Post" onsubmit="return confirm('Apakah Data Kritik dan Saran {{$CriticAndSuggestion->subjek}} Ingin Dihapus?')">
                          @csrf
                        <a href="{{url('/admin/kritikdansaran.'.$CriticAndSuggestion->id_criticandsuggestion.'.detail')}}" class="btn btn-xs btn-info" title="Detail"><i class="fas fa-eye"></i></a>
                  ...
                  <div class="col-sm-12">                  
                      <div class="alert alert-danger" 
                       role="alert">Data dengan Kata Kunci : {{ $cari }} Tidak Ditemukan,   
                        <a href="{{url('/admin/kritikdansaran')}}"><input 
