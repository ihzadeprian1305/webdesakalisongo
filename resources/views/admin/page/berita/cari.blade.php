              ...
              <div class="col-md-12">
                ...
                <div class="col-sm-12">                  
                      <div class="alert alert-success" 
                       role="alert">Ditemukan {{ $JumlahDataBerita }} data dengan kata kunci : {{ $cari }}
                      </div>
                </div>
                    ...
                    <tr>
                        ...
                        <td align="center">
                         <form action="{{url('/admin/berita.'.$News->id_news)}}" method="Post" onsubmit="return confirm('Apakah Data Berita {{$News->judul}} Ingin Dihapus?')">
                          @csrf
                        <a href="{{url('/admin/berita.'.$News->id_news.'.detail')}}" class="btn btn-xs btn-info" title="Detail"><i class="fas fa-eye"></i></a>
                          
                       <a href="{{url('/admin/berita.'.$News->id_news.'.edit')}}" class="btn btn-xs btn-info" title="Edit"><i class="fas fa-edit"></i></a>   
