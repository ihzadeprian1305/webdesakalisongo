              ...
              <div class="col-md-12">
                ...
                <div class="col-sm-12">                  
                      <div class="alert alert-success" 
                       role="alert">Ditemukan {{ $JumlahDataFoto }} data dengan kata kunci : {{ $cari }}
                      </div>
                </div>
                    ...
                    <tr>
                        ...
                        <td align="center">
                         <form action="{{url('/admin/foto.'.$Photo->id_photo)}}" method="Post" onsubmit="return confirm('Apakah Data Foto {{$Photo->foto}} Ingin Dihapus?')">
                          @csrf
                        <a href="{{url('/admin/foto.'.$Photo->id_photo.'.detail')}}" class="btn btn-xs btn-info" title="Detail"><i class="fas fa-eye"></i></a>
                          
                       <a href="{{url('/admin/foto.'.$Photo->id_photo.'.edit')}}" class="btn btn-xs btn-info" title="Edit"><i class="fas fa-edit"></i></a>   
